 ...
 * 2. Compile: compile the raid configurations and prepare them for execution.
 * 3. Execute: run the raid commands based on the compiled configurations.
 * 4. Cleanup: clean up any resources used during the raid execution.
 * 5. Shutdown: gracefully shut down the raid environment, ensuring all resources are released and saved.
 */
